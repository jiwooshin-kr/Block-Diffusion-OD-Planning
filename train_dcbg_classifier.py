...
if __name__ == "__main__":
    ...
    A_nrm_ = pickle.load(open(join(args.porto, f"porto_shrink_A_v4-{fam}_normal.ts"), "rb")).bool().float()
    for e in exceptions:
        sp_e = pickle.load(open(join(args.porto, f"porto_shrink_SP_v4-{fam}_except_{e}.pkl"), "rb"))
        ...
        A_e = pickle.load(open(join(args.porto, f"porto_shrink_A_v4-{fam}_except_{e}.ts"), "rb")).bool().float()
        exc_A[e] = A_e
