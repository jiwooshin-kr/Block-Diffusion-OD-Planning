...
Controlled evaluation of the v2 (seeded-split) block-size sweep, both kernels:
  ...
  python tools/eval/eval_bd_sweep_controlled.py -kernel mask  -blocks 1,2,4,8,16,32,64
  python tools/eval/eval_bd_sweep_controlled.py -kernel graph -blocks 1,2,4,8,16,32,64
"""
