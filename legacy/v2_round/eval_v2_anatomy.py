...
on the shared held-out set (default 1,000 pairs).
  ...
  CUDA_VISIBLE_DEVICES=0 python legacy/v2_round/eval_v2_anatomy.py -kernel mask  -blocks 1,2,4,8,16,32,64
  CUDA_VISIBLE_DEVICES=1 python legacy/v2_round/eval_v2_anatomy.py -kernel graph -blocks 1,2,4,8,16,32,64
"""
